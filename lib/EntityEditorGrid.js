...
Ext.define('PP.EntityEditorGrid',{
	...
	lexicon: PP.lexicon,
	baseurl: PP.config.inv_api_path,
	mode: 'editor',
	selType: 'rowmodel',
	// plugins: [
...
//	fields:false,
	...
	columnConfig:function(field){
		return {
			...
			editor: PP.getEditorConfig(field,{entity:this.entity,labels:false}),
	...
	initComponent: function(){
		...
		{
			this.columns.push({header: '',dataIndex: 'id', renderer:this.deleteColumnRenderer,flex:0, width: 47});
		}
		if(this.mode=='editor')
		{
			var me=this;
