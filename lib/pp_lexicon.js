...
PP.getEntityFields=function(entity){
    ...
    if(typeof PP.entities[entity] == 'object')
    {
        ...
        {
            if(entity_fieldlist[i] != 'key' && entity_fieldlist[i] != 'extends')
            {
...
PP.getEditorConfig = function(editor_name,opts) {
    ...
    else
    {
        ...
        {
            if (PP.entities[opts.entity][editor_name].format == 'text')
            {
                            ...
                            url: (
									editor_name == 'environment_name' ?
									 ...
									 : (
										editor_name == 'svc_id' ? 
										 PP.config.cmdb_api_path + 'service_instance/?type!=environment'
										: ( editor_name =='roles'? PP.config.cmdb_api_path + 'role/' : PP.config.cmdb_api_path + 'column_lkup/' + opts.entity + '/' + editor_name)
									  )
								 ),
                            method: 'GET'
                        },
    ...
    if(PP.entities[opts.entity][editor_name] && PP.entities[opts.entity][editor_name].flavor == 'fact')
    {
...
var url=PP.config.cmdb_api_path + 'currentUser/' + PP.currentUser,
