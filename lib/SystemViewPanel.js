...
Ext.define('PP.SystemViewPanel', {
    ...
    initComponent: function() {
        ...
        entity_field_list.forEach(function(field_name) {
            ...
            if (entity_definition[field_name]._field_category == undefined) {
                entity_definition[field_name]._field_category = 'More Data';
            }
            ...
            if (me.field_config[entity_definition[field_name]._field_category] == undefined) {
                me.field_config[entity_definition[field_name]._field_category] = [];
            }
            me.field_config[entity_definition[field_name]._field_category].push(tmp);
        });
                    ...
                    fn: function() {
                        ...
                        for(var field in r.getChanges())
                        {
                            ...
                            else
                            {
                                ...
                                if(Array.isArray(r.data[field]) && r.data[field].join(',') == r.modified[field])
                                {
                                    continue;
                                }
