...
Ext.define('PP.SystemViewPanel',{
	...
	initComponent: function(){
		...
		Ext.each(this.hw_fields.sort(),function(item){
			var tmp=PP.getEditorConfig(item,{entity:'system',labels:true});
			tmp['instance']=this;
			if(tmp['listeners'])
			{
		...
		Ext.each(this.conf_fields.sort(),function(item){
			var tmp=PP.getEditorConfig(item,{entity:'system',labels:true});
			tmp['instance']=this;
			if(tmp['listeners'])
			{
		...
		Ext.each(PP.getEntityFields(this.entity).sort(),function(item){
